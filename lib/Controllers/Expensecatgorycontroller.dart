...
class ExpenseCategoryController extends GetxController {
  final String userId;
  ExpenseCategoryController(this.userId);
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonData['status'] == "success") {
          ...
          Get.snackbar(
            "Info",
            jsonData['message'] ?? "No expense categories found",
      ...
      Get.snackbar(
        "Error",
        "Error fetching expense categories: $e",
        backgroundColor: Colors.red,
        colorText: Colors.white,
  ...
  Future<void> addCategory(String name, String iconCode) async {
    try {
      ...
      String apiUrl = ApiService.getUrl("fd_insert_exp.php");
